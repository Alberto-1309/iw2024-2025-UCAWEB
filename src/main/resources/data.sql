insert into application_user (version, id, email, username, name, hashed_password, profile_picture) values
    ...
    (1, 23, 'otp@otp.otp', 'otp', 'OTP', '$2a$10$xdbKoM48VySZqVSU/cSlVeJn0Z04XCZ7KZBjUBC00eKo5uLswyOpe', ''),
    (1, 24, 'cio@cio.cio', 'cio', 'CIO', '$2a$10$xdbKoM48VySZqVSU/cSlVeJn0Z04XCZ7KZBjUBC00eKo5uLswyOpe', '');
...
insert into convocatoria (id, nombre, fecha_apertura, fecha_cierre, objetivo) values (1, 'Convocatoria 2024/25', '2024-09-01', '2025-06-31', "Make UCA great again");
